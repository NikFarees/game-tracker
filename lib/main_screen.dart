    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.article_outlined), label: 'Media'),
          BottomNavigationBarItem(icon: Icon(Icons.person_outline), label: 'Profile'),
          BottomNavigationBarItem(icon: Icon(Icons.add_box_outlined), label: 'Form'),
        ],
      ),
    );
  }
          ...
          DrawerHeader(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('GameLog member', style: TextStyle(color: Colors.grey)),
              ],
            ),
          ),
